...
paser.add_argument('--batchsize', type = int, default = 16)
paser.add_argument('--img_size', type = int, default = 120, help = 'image size')
paser.add_argument('--lr', type = float, default = 0.0001, help = 'learning rate')
paser.add_argument('--weight_decay', type = float, default = 1e-3, help = 'wegiht decay')
